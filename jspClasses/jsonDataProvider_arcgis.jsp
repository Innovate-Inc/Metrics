...
class jsonDataProvider {
        ...
        public ResultSet getInventoryData(HashMap filters, boolean forExport) {
            ...
            sql += ",(CASE WHEN publisher.val LIKE 'U.S. Environmental Protection Agency%' THEN 'U.S. EPA' WHEN publisher.val LIKE 'U.S. EPA%' THEN 'U.S. EPA' ELSE 'Non-EPA' END) as epapub";
