...
<%@page import="java.util.Properties"%><%@page import="java.io.PrintWriter,java.sql.ResultSet,java.sql.ResultSetMetaData,java.sql.SQLException"%><%@page import="java.util.ArrayList,java.util.HashMap,java.util.Iterator,java.util.logging.Level"%><%@page import="java.util.logging.Logger,java.sql.*,java.util.Collection,java.util.HashMap"%><%@page import="java.util.regex.Matcher,java.util.regex.Pattern"%><%!
    /**
     *
     * @author Deewen
     */
    public class jsonServer {
        ...
        public ResultSet executeQuery(String sql, ArrayList params) {
            Logger.getLogger(jsonServer.class.getName()).log(Level.SEVERE, sql);
