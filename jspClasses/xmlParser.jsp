...
<%@page import="org.w3c.dom.Node, org.w3c.dom.NodeList"%>
<%@page import="org.w3c.dom.Document, java.io.StringReader, org.xml.sax.InputSource, javax.xml.parsers.DocumentBuilderFactory, javax.xml.parsers.DocumentBuilder"%>
<%!
    class node {
